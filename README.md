...
/* PWA Install Banner UI */
        .install-banner { 
            ...
            padding: 15px 20px; z-index: 99999999; display: flex; 
            justify-content: space-between; align-items: center; 
            border-bottom: 2px solid var(--gold-primary); 
            box-shadow: 0 10px 30px rgba(0,0,0,0.8); 
            transition: top 0.5s cubic-bezier(0.2, 0.8, 0.2, 1); 
        }
        .install-banner.show { top: 0; }
        /* GATEKEEPER */
   ...
   <!-- PWA Install Notification Banner -->
    <div id="pwa-install-banner" class="install-banner">
        <div style="display:flex; align-items:center; gap:12px;">
            <img src="https://i.postimg.cc/76mz1v2j/file-0000000090a471fa84cbecd48a774885.png" style="width:40px; height:40px; border-radius:8px; box-shadow: 0 0 10px rgba(212,175,55,0.3);">
            <div>
                <div style="color:var(--gold-primary); font-family:'Cinzel'; font-weight:bold; font-size:15px;">MND Hub App</div>
                <div style="color:#aaa; font-size:11px; font-family:'Outfit';">Install for native full-screen access</div>
            </div>
        </div>
        <div style="display:flex; align-items:center; gap:15px;">
            <button class="mn-btn" style="width:auto; padding:8px 15px; margin:0; font-size: 12px; border-radius: 6px; background: var(--gold-primary); color: #000;" onclick="installPWAApp()">INSTALL</button>
            <i class="fas fa-times" style="color:#888; font-size: 20px; cursor: pointer; transition: 0.3s;" onclick="closeInstallBanner()"></i>
        </div>
    </div> 
</head>
